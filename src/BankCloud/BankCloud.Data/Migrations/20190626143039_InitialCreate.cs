        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullNameId = table.Column<string>(nullable: false),
                    IdentityNumber = table.Column<string>(nullable: false),
                    AddressId = table.Column<string>(nullable: false),
                    OptionalAddressId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Addresses_OptionalAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Liabilities = table.Column<decimal>(nullable: false),
                    Balance = table.Column<decimal>(nullable: false),
                    ProductCurencyId = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Products_Curencies_ProductCurencyId",
                        column: x => x.ProductCurencyId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_OptionalAddressId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_ProductCurencyId",
                table: "Products",
                column: "ProductCurencyId");
        }
